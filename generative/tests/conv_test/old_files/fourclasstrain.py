...
from generators import FourClassGenerator
...
if __name__ == "__main__":
    ...
    def reset_generators():
        train_generator = FourClassGenerator(args.photo_emb_dir, args.sketch_emb_dir,
                                             batch_size=args.batch_size, train=True,
                                             use_cuda=args.cuda)
        test_generator = FourClassGenerator(args.photo_emb_dir, args.sketch_emb_dir,
