...
class Generator(object):
    ...
    def make_generator(self):
        ...
        for i in range(self.size):
            ...
            sketch1_category = CATEGORY_NAME2IX_DICT[gen_category_from_path(sketch1_path)]
            sketch2_category = CATEGORY_NAME2IX_DICT[gen_category_from_path(sketch2_path)]
            sketch_categories = torch.tensor([sketch1_category, sketch2_category, sketch1_category, sketch2_category])
            # gen instance metrics
            sketch1_instance = INSTANCE_IX2NAME_DICT[gen_instance_from_path(sketch1_path)]
            sketch2_instance = INSTANCE_IX2NAME_DICT[gen_instance_from_path(sketch2_path)]
            sketch_instances = torch.tensor([sketch1_instance, sketch2_instance, sketch1_instance, sketch2_instance])
...
def gen_category_from_path(path):
    instance = gen_category_from_path(path)
