...
from model import LabelPredictorFC6
...
if __name__ == "__main__":
    ...
    train_dataset = SketchOnlyDataset(layer='fc6', split='train')
    val_dataset = SketchOnlyDataset(layer='fc6', split='val')
    test_dataset = SketchOnlyDataset(layer='fc6', split='test')
