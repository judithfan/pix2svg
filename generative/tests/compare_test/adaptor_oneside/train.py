...
if __name__ == "__main__":
    ...
    train_dataset = VisualDataset(layer='conv42', split='train', synthetic_labels=args.synthetic_labels)
    val_dataset = VisualDataset(layer='conv42', split='val', synthetic_labels=args.synthetic_labels)
    test_dataset = VisualDataset(layer='conv42', split='test', synthetic_labels=args.synthetic_labels)
