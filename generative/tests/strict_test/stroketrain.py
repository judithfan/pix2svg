...
from generators2 import DropStrokeGenerator
...
if __name__ == "__main__":
    ...
    parser.add_argument('--drop_proba', type=float, default=0.5)
    ...
    def reset_generators():
        train_generator = DropStrokeGenerator(args.photo_emb_dir, args.sketch_emb_dir,
                                              batch_size=args.batch_size, train=True,
                                              use_cuda=args.cuda, drop_proba=args.drop_proba)
        test_generator = DropStrokeGenerator(args.photo_emb_dir, args.sketch_emb_dir,
