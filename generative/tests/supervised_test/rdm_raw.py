...
if __name__ == "__main__":
    ...
    parser.add_argument('--model-path', type=str, default='./trained_models/raw/model_best.pth.tar',
                        help='where trained models are stored [default: ./trained_models/raw/model_best.pth.tar]')
