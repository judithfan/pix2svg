...
class SketchPlus32Photos(Dataset):
    ...
    def __init__(self, photo_transform=None, sketch_transform=None):
        ...
        # only keep sketches that are in the valid_gameids
        ...
        # load all 32 of them once since they are all the same.
