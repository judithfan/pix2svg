...
class SketchPlusPhotoGroup(Dataset):
...
class SketchPlusPhoto(SketchPlusPhotoGroup):
    def __init__(self, layer='fc6', train=True, return_paths=False, soft_labels=False,
                 photo_transform=None, sketch_transform=None):
        super(SketchPlusPhoto, self).__init__(
    ...
    def negative_sample(self):
        ...
        for i in tqdm(xrange(len(pos_sketch_paths))):
    ...
    def __getitem__(self, index):
        ...
        photo_object_name = os.path.splitext(os.path.basename(photo_path))[0]
